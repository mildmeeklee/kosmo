...
<body>
	<form action="programwrite.do" method="POST">
		...
		시간:: <select name="p_time">
						...
						<option value="1400_1500">1400-1500</option>
						<option value="1500_1600">1500-1600</option>
						<option value="1600_1700">1600-1700</option>
						<option value="1700_1800">1700-1800</option>
						<option value="1800_1900">1800-1900</option>
						<option value="1900_2000">1900-2000</option>
						<option value="2000_2100">2000-2100</option>
						<option value="2100_2200">2100-2200</option>
					</select></br>
		내용 :: <br/>
