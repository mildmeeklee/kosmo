...
<div id="layout">
	...
	<input type="button" value="회사소개" class="button" onclick="javascript:window.location='introcompanyIntro.do'"><br>
	
	<input type="button" value="헬스프로그램" class="button" onclick="javascript:window.location='introhealthProgram.do'">
	
	<input type="button" value="프로그램 강사" class="button" onclick="javascript:window.location='introprogramTeacher.do'"><br>
	
	<input type="button" value="시설" class="button" onclick="javascript:window.location='introfacility.do'"><br>
	
	<input type="button" value="제휴회사" class="button" onclick="javascript:window.location='introalianceBusiness.do'"><br>
	</p>
	</div>
	<!-- --------------------------------------------- -->
